/**
 * MDast Types
 * <https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/mdast/mdast-tests.ts>
 *
 * The following is a modified version of the Mdast types to add our custom
 * extensions like `sup` and `sub`.
 *
 * Customized types have comments with the keyword `custom`
 */
